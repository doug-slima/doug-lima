...
function itemClass(active: boolean, variant: "pill" | "underline") {
  if (variant === "pill") {
    return active
      ? "flex items-center px-4 h-[32px] rounded-full font-fenix text-[24px] text-text-active ring-1 ring-[#3B4028]"
      : "flex items-center px-4 h-[32px] rounded-full font-fenix text-[24px] text-text-default hover:text-text-active hover:bg-[#EAFBAB] hover:ring-1 hover:ring-[#AEE000] transition-all";
  }
  return active
