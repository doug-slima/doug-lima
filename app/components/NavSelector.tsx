...
function itemClass(active: boolean, variant: "pill" | "underline") {
  if (variant === "pill") {
    return active
      ...
      : "flex items-center px-3 md:px-4 h-[28px] md:h-[32px] rounded-full font-fenix text-[20px] md:text-[24px] text-text-default hover:text-text-active hover:ring-1 hover:ring-[#AFB4A7] transition-all";
  }
  return active
